...
use Kamille\Utils\Morphic\FormConfigurationProvider\FormConfigurationProviderInterface;
use Kamille\Utils\Morphic\ListConfigurationProvider\ListConfigurationProviderInterface;
...
class A
{
    ...
    public static function getMorphicListConfig($module, $identifier, array $context=[])
    {
        /**
         * @var $confProvider ListConfigurationProviderInterface
         */
        $confProvider = X::get("Core_MorphicListConfigurationProvider");
        return $confProvider->getConfig($module, $identifier, $context);
    }

    public static function getMorphicFormConfig($module, $identifier, array $context=[])
    {
        /**
         * @var $confProvider FormConfigurationProviderInterface
         */
        $confProvider = X::get("Core_MorphicFormConfigurationProvider");
        return $confProvider->getConfig($module, $identifier, $context);
    }
    ...
    {
        return ApplicationRegistry::get("core.routsyRouteId");
    }
    ...
    /**
     * @return DerbyCacheInterface
     */
    public static function cache()
    {
//        return X::get("Core_TabathaCache"); // deprecated
        return X::get("Core_DerbyCache");
    }
